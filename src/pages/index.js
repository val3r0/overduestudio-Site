...
position: absolute;
transform: ${({div}) => (div ? "scale(100,100)" : "")};
transition: transform 800ms ease-in-out;
z-index: 2;
...
function Home() {
  ...
  return (
    <Wrapper id="top">
      ...
      <Menuwrapper>
        <Menulogo div={div}>
          <svg width="23vw" height="auto" viewBox="0 0 454 54" fill="none" xmlns="http://www.w3.org/2000/svg">
